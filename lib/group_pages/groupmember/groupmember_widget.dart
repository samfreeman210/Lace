...
import 'groupmember_model.dart';
export 'groupmember_model.dart';
...
class _GroupmemberWidgetState extends State<GroupmemberWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupmemberModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<GroupsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final groupmemberGroupsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Align(
                ...
                child: Text(
                  groupmemberGroupsRecord.groupName,
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    formatNumber(
                                      columnGroupsRecord.groupUserList.length,
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          columnGroupsRecord.groupAvatar,
                                          width: 100.0,
                                          height: 100.0,
                                          fit: BoxFit.cover,
                                        ),
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            24.0, 12.0, 24.0, 0.0),
                        child: Text(
                          columnGroupsRecord.groupDescription,
                          textAlign: TextAlign.center,
                          style:
                      ...
                      if (columnGroupsRecord.groupOwner?.id ==
