...
import 'groups_copy_model.dart';
export 'groups_copy_model.dart';

class GroupsCopyWidget extends StatefulWidget {
  const GroupsCopyWidget({Key? key}) : super(key: key);

  @override
  _GroupsCopyWidgetState createState() => _GroupsCopyWidgetState();
}

class _GroupsCopyWidgetState extends State<GroupsCopyWidget> {
  late GroupsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupsCopyModel());
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(28.0, 50.0, 5.0, 0.0),
                      child: FlutterFlowIconButton(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        listViewGroupsRecord.groupAvatar,
                                        width: 60.0,
                                        height: 60.0,
                                        fit: BoxFit.cover,
                                      ),
