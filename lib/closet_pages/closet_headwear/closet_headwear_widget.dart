...
import 'closet_headwear_model.dart';
export 'closet_headwear_model.dart';

class ClosetHeadwearWidget extends StatefulWidget {
  const ClosetHeadwearWidget({
    Key? key,
    String? clothingType,
  })  : this.clothingType = clothingType ?? 'Headwear',
        super(key: key);

  final String clothingType;

  @override
  _ClosetHeadwearWidgetState createState() => _ClosetHeadwearWidgetState();
}

class _ClosetHeadwearWidgetState extends State<ClosetHeadwearWidget> {
  late ClosetHeadwearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClosetHeadwearModel());
  }
