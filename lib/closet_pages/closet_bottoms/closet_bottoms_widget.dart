...
import 'closet_bottoms_model.dart';
export 'closet_bottoms_model.dart';

class ClosetBottomsWidget extends StatefulWidget {
  const ClosetBottomsWidget({
    Key? key,
    String? clothingType,
  })  : this.clothingType = clothingType ?? 'Bottoms',
        super(key: key);

  final String clothingType;

  @override
  _ClosetBottomsWidgetState createState() => _ClosetBottomsWidgetState();
}

class _ClosetBottomsWidgetState extends State<ClosetBottomsWidget> {
  late ClosetBottomsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClosetBottomsModel());
  }
