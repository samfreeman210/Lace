...
Future<String?> clothinGenBottom(DocumentReference? userRef) async {
  ...
  var bottomIndex = random.nextInt(clothingListBottoms.length);

  //debugPrint("Hello world");
  var randomClothing = clothingListBottoms[bottomIndex];
